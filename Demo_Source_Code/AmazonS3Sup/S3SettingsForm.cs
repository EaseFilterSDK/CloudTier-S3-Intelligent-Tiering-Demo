...
namespace CloudTier.AmazonS3Sup
{
    public partial class S3SettingsForm : Form
    {
        ...
        private void button_ApplyS3Setting_Click(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                MessageBox.Show("Save S3 setting failed with error " + ex.Message, "Save S3 setting.", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
