...
namespace CloudTier.AmazonS3Sup
{
    ...
    public class AsyncTask : IDisposable
    {
        ...
        private AmazonS3SiteInfo siteInfo = null;
        ...
        private void LoadDownloadedBitmap()
        {
            try
            {
                ...
                {
                    int bytes = (int)Math.Ceiling(Math.Ceiling((double)(fileSize) / DownloadBlockSize) / 8);
        ...
        public AmazonS3SiteInfo AmazonS3SiteInfo
        {
            get { return siteInfo; }
            set { siteInfo = value; }
        }
        ...
        /// <summary>
        /// the s3 upload block size.
        /// </summary>
        public long S3UploadBlockSize
        {
            get
            {
                if (siteInfo.PartSize > blockSize)
                {
                    return siteInfo.PartSize;
                }
        ...
        public Boolean GetAndSetNextBlockOffset(out long offset,out string getOffsetError)
        {
            ...
            try
            {
                ...
                lock (this)
                {
                    ...
                    nextBlockOffset += DownloadBlockSize;
                }
